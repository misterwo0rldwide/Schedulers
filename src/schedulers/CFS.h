...
class prioNice {
    public:
    static const size_t prio_weight[40];
    static size_t get_nice_weight(int8_t nice) { return prioNice::prio_weight[nice + 20]; }
};

const size_t prioNice::prio_weight[40] = {88817, 71054, 56843, 45474, 36379, 29103, 23283,
